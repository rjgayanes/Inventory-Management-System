...
<head>
    <meta charset="UTF-8">
    <title>Semi-Expendable Properties Inventory</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <?php else: ?>
            <h2>IVENTORY FOR SEMI EXPENDABLE PROPERTY</h2>
        <?php endif; ?>
    ...
    <table>
        ...
        <tbody>
            ...
            if ($inventory_result->num_rows > 0) {
                ...
                ?>
                <tr><td colspan="14" class="text-center">No Semi-Expendable Properties found</td></tr>
                <?php
            }
            ?>
        </tbody>
...
// For simple HTML to PDF conversion, we'll use the browser's print functionality
// This creates a print-friendly HTML that can be saved as PDF by the browser
echo $html;

// Log activity
include 'activity_logger.php';
log_activity($conn, $_SESSION['user_ID'], "Exported SEP inventory to PDF");
